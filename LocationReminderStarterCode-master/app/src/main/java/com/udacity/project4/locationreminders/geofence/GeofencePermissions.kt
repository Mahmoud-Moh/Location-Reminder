...
class GeofencePermissions(val myContext: Context, val myActivity: Activity) {
     ...
     fun onRequestPermissionsResult(
                    ...
                    PackageManager.PERMISSION_DENIED))
        {
           *//* Snackbar.make(
            ...
            Toast.makeText(myContext, "Please give permissions", Toast.LENGTH_LONG)
        } else {
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        ...
        val settingsClient = LocationServices.getSettingsClient(myActivity)
        val locationSettingsResponseTask =
            settingsClient.checkLocationSettings(builder.build())
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve){
                try {
                    exception.startResolutionForResult(myActivity,
                ...
                *//*Snackbar.make(
                ...
                Toast.makeText(myContext, "Error getting location settings resolution", Toast.LENGTH_LONG)
            }
        }
